...
import Social from "../../utils/socialCard/Social";
...
export default function Contact() {
  ...
  useEffect(() => {
    setValue("subject", `${userName} sent a message from your Portfolio`);
  }, [userName, setValue]);
  ...
  return (
    <div className="max-w-screen-xl mx-auto">
      <SectionHeader sectionTitle={"Contact"}></SectionHeader>

      <div className="flex flex-col justify-center items-center md:flex md:items-center md:justify-around md:flex-row">
        <div className="w-full max-w-md my-5 border border-gray-100 rounded-md p-7">
          {!isSubmitSuccessful && (
            <form onSubmit={handleSubmit(onSubmit)}>
              <input
                type="hidden"
                value="23d304aa-08f8-43d1-a53e-6a018541a426"
                {...register("access_key")}
              />
